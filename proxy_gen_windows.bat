...
%GRPC_TOOLS%\protoc.exe -Isrc/Common/proto --csharp_opt=file_extension=.g.cs --csharp_out src/Common/gRpc/csharp --grpc_out src/Common/gRpc/csharp --plugin=protoc-gen-grpc=%GRPC_TOOLS%\grpc_csharp_plugin.exe src\Common\proto\*.proto
